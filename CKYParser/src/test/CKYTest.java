...
public class CKYTest {
	...
	@Test
	public void testParserOneTree() throws UnknownWordException {
		...
		System.out.println("No unknown words in the input. One parse.");
		
		CKY parser = new CKY(g);
		
		LinkedList<Tree> res = parser.parse(Symbol.ListSymbols(("\\fish \\people \\fish \\tanks").split(" ")), 1);
		String tree = res.getFirst().treeToString();
