...
usage=u""" Ce programme lit de STDIN une grammaire hors-context (probabiliste ou non) (CFG ou PCFG) 
           ...
           2. Chaque ligne au format suivant:
            ...
            ( field separator : whitespace characters )
              Non-terminal symbols: contains at least one uppercase letter
              Terminal symbols: does not contain uppercase letters
...
help = u"Indicate that there may be non-terminal symbols in non-singular.....")
