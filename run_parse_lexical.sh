...
# ------ input arguments ------------
## grammar file
f_grammar="/home/yuliya/Paris-Diderot/2ieme_semestre/Projet/PR/CKYParser/RESULTS/PCFG/lowercase/pcfg_lex.txt.CNF"
# -----------------------------------
DIR=`dirname $0`
...
echo "============== Lexical parse: =============="
"$REINSERT" "$f_parse" "$f_tagged_phrase" > "parse"
java -jar "$DIR""/BackConverter.jar" --input_file "parse" --prefixe "Z"
